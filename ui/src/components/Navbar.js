      ...
      <Toolbar id="navbar-fixed" className={classes.toolbar}>
        ...
        <AppBar position="static" color="default" elevation={0} className={classes.appBar}>
          <Toolbar className={classes.toolbar}>
            ...
            <div>
              <Link variant="button" color="textPrimary" to="/register" className={classes.link}><PersonAddOutlinedIcon/> Inscription</Link>
              <Link variant="button" color="textPrimary" to="/login" className={classes.link}><PermIdentityOutlinedIcon/> Connexion</Link>
            </div>
